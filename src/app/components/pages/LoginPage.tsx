    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-cyan-500 to-teal-400 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl text-white mb-2">Selamat Datang</h1>
          <p className="text-blue-100">Masuk ke akun MEDIXA Anda</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="space-y-3">
            <button className="w-full py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-2">
              ...
              <span className="text-gray-700">Lanjutkan dengan Google</span>
            </button>
